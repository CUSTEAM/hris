...
public class EmplStaticWorkManagerAction extends BaseAction{
	public String shift, shifts, idno, unit, Oid[], wshift[];
	...
	public String search(){
		...
		StringBuilder sql=new StringBuilder("SELECT e.sname,c.id, c.name as unitName, e.cname, e.Oid, "
				+ "e.WorkShift FROM empl e LEFT OUTER JOIN CODE_UNIT c ON e.unit=c.id WHERE e.cname IS NOT NULL ");
